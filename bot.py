...
async def on_member_join(userName: discord.User):
    joins = ["**Welcome to Violets™ @{}! :sparkels: Please make sure to read the rules and if you want to partner, contact any of the staff with the role Partnership Manager :smiley: Also don't forget to get roles and colors in the self role channel :wink: Enjoy your stay :sparkling_heart:**".format(userName)]
